...
/**
 * Calculate the movement (cm) and direction
 *
 * @param {Object} current coordinate
 * @param {Number} Height (cm)
 * @param {Object} Destinations point - clicked {x,y}
 * @returns {Object} {distance: cm, rotate: degrees}
 */
